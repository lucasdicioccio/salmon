...
- salmon-ops-recipes-experimental: recipes that pull in heavier/less-stable dependencies (e.g., kitchen-sink), kept out of salmon-ops-recipes so that it stays quick and easy to build; not part of the default `cabal.project` package set
